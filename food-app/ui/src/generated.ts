...
export type LibraryBook = { path: string, title: string, authors: Array<string>, subjects: Array<string>, cookbook: boolean, error: string | null, };
...
export type CookbookResult = { path: string | null, source: string, model: string, sourceHash: string, incomplete: boolean, reservedUsd: number, documents: Array<SourceDocument>, recipes: Array<CookbookRecipe>, chunks: Array<CookbookChunk>, review: Array<ReviewNote>, 
/**
...
export type ExtractionProgress = { path: string, completed: number, total: number, recipes: number, reservedUsd: number, };
