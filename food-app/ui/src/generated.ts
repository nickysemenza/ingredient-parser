...
export type ExtractionPreview = { policy?: Array<string>, extractionRemainingUsd?: number, verificationRemainingUsd?: number, total: number, cached: number, pending: number, lowUsd: number | null, highUsd: number | null, reservationUsd: number | null, basis: string, };
