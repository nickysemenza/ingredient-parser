          ...
          <div className="flex flex-col items-center md:flex-row">
            <div className="w-full mt-16 md:mt-0 md:w-2/5">
              <div className="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
                ...
                <input
                  type="text"
                  className="block w-full px-4 py-3 mb-4 border-2 border-gray-200 rounded-lg focus:ring-3 focus:ring-blue-500 focus:outline-hidden"
                  value={text}
    ...
    <div>
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-2/3">
          ...
          <input
            type="text"
            className="w-full h-12 px-4 py-3 mb-4 border-2 border-gray-200 rounded-lg focus:ring-3 focus:ring-blue-500 focus:outline-hidden"
            value={url}
